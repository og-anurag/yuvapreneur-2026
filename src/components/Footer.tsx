...
export default function Footer() {
  return (
    <footer className="border-t" style={{ borderColor: "var(--beige)", backgroundColor: "var(--cream-deep)" }}>
        ...
        <div className="grid gap-10 md:grid-cols-[1.3fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed" style={{ color: "var(--green-soft)" }}>
              A student founder gathering at the University of Allahabad. Bring the idea, find the people,
              make it real.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm" style={{ color: "var(--green-soft)" }}>
              <li><Link to="/schedule" className="hover:opacity-70">Schedule & venue</Link></li>
              <li><Link to="/games" className="hover:opacity-70">Find your game</Link></li>
              <li><Link to="/committee" className="hover:opacity-70">Meet the committee</Link></li>
